...
public class TransLineageHolderMap {
  ...
  public synchronized void putLineageHolder( Trans t, LineageHolder holder ) {
   ...
   */
  public synchronized LineageHolder removeLineageHolderImpl( final Trans t  ) {
  ...
  public synchronized LineageHolder removeLineageHolder( Trans t  ) {
    ...
    if ( t.getParentTrans() == null && t.getParentJob() == null ) {
      ...
      TransLineageHolderMap.getInstance().getLineageHolder( t.getParentTrans() ).addSubTransOrJob( t );
