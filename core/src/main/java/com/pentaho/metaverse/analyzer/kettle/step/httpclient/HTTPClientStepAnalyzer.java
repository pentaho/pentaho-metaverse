 ...
 * metaverse entities
 */
public class HTTPClientStepAnalyzer extends BaseStepAnalyzer<HTTPMeta> {
  private Logger log = LoggerFactory.getLogger( HTTPClientStepAnalyzer.class );

  @Override
  public IMetaverseNode analyze( IComponentDescriptor descriptor, HTTPMeta httpMeta ) throws MetaverseAnalyzerException {
