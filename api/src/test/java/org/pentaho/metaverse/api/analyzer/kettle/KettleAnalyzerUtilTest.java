...
public class KettleAnalyzerUtilTest {
  ...
  public void test_getResourcedFromMeta() throws Exception {
    ...
    assertEquals( 3, resourceMap.get( KettleAnalyzerUtil.getUniqueId( meta ) ).size() );
    ...
    assertEquals( 2, resourceMap.get( KettleAnalyzerUtil.getUniqueId( meta2 ) ).size() );
  ...
  public void test_getUniqueId() {
    ...
    assertEquals( System.getProperty( "user.dir" ) + File.separator + "my_file::test",
      KettleAnalyzerUtil.getUniqueId( meta ) );
  }
}
