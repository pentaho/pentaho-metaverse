...
public class ExternalResourceCache {
  ...
  protected static final long DEFAULT_TIMEOUT_SECONDS = 6 * 60 * 60; // 6 hours

  protected volatile Cache<String, ExternalResourceValues> resourceCache;
  ...
  void initCache( long time, TimeUnit timeUnit ) {
    ...
    log.debug( this.getClass().getSimpleName() + " cache expire time set to " + time + " " + timeUnit );
  }
