...
import org.pentaho.platform.api.metaverse.IMetaverseElement;
...
public class MetaverseBuilder implements IMetaverseBuilder, IMetaverseObjectFactory {
  ...
  /**
   * determines if the node passed in is a virtual node (meaning it has been implicitly added to the graph by an addLink)
